![webis logo](./docs/img/webis-logo-gray.png "Logo of the Webis network") ![scriptor logo](./docs/img/scriptor-logo.webp "Logo of Scriptor: Generated by DALL-E for 'a stained glass window depicting a medieval scriptor writing with a quill pen on a modern laptop'") Webis Scriptor
==============
